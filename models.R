...
fit_cat <- function(df, params, ...) {
  ...
  # Run training and capture any outputs generated by catboost.train.
  # catboost.train() calculates feature importance in any run and reports
